package com.coolenoughsmile.foto.mapActivity;
        ...
        public void onGetSuggestionResult(SuggestionResult res) {
            ...
            if (datas != null) {
                ...
                for (SuggestionResult.SuggestionInfo suggestionInfos : res.getAllSuggestions()) {
                    //过滤掉不合法的地理位置
                    if ("".equals(suggestionInfos.city.trim())&& "".equals(suggestionInfos.district.trim())){
                        continue;
                    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_search_send:
                if (!TextUtils.isEmpty(et_search.getText().toString())) {
                    ...
                    // 根据输入框的内容，进行搜索
                    mSuggestionSearch.requestSuggestion(new SuggestionSearchOption().keyword(et_search.getText().toString()).city("天津"));
                } else {
